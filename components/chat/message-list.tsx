...
export function MessageList({ messages, currentUser, onReply, activeReplyId }: MessageListProps) {
...
function ThreadMessage({
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className="flex flex-col w-full min-w-0">
          ...
          <div className="flex items-baseline gap-2 flex-wrap">
            ...
            {message.isEdited && <span className="text-xs text-[#72767d]">(edited)</span>}
            {message.isPinned && (
      ...
      {/* Replies Section */}
      {hasReplies && (
        <div className={`mt-2 relative ${depth < MAX_NESTING_DEPTH ? 'ml-12' : 'ml-4'}`}>
