...
export function usePressDepth(
  ...
  }, [tracking, disabled, setDown, stop]);
  ...
  return (
    ...
    >
      <span
        aria-hidden
        style={{ top: depth }}
        className="absolute inset-x-0 bottom-0 rounded-[9px] bg-muted dark:bg-white/25"
      />
      <motion.span
        initial={false}
        animate={{
        ...
        className={`relative inline-flex h-9 items-center justify-center gap-2 rounded-[9px] border border-border bg-card px-3.5 text-[13px] font-medium text-foreground group-focus-visible:ring-2 group-focus-visible:ring-ring dark:border-line dark:bg-surface dark:text-foreground dark:group-focus-visible:ring-ring ${className}`}
      >
        <motion.span
          aria-hidden
          initial={false}
